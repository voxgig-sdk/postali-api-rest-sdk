...
## Install
```bash
go get github.com/voxgig-sdk/postali-api-rest-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/postali-api-rest-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/postali-api-rest-sdk/go=../postali-api-rest-sdk/go
```
...
```
POSTALI_API_REST_TEST_LIVE=TRUE
```
...
```
github.com/voxgig-sdk/postali-api-rest-sdk/go/
...
The root package (`github.com/voxgig-sdk/postali-api-rest-sdk/go`) re-exports everything needed
