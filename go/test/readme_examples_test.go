...
const testSeed = `map[string]any{"entity": map[string]any{"municipality": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "postal_code": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "state": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
