...
type PostalCodeEntity struct {
	name    string
	client  *core.PostaliApiRestSDK
...
func NewPostalCodeEntity(client *core.PostaliApiRestSDK, entopts map[string]any) *PostalCodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PostalCodeEntity) GetName() string { return e.name }
...
func (e *PostalCodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PostalCodeEntity) Deleted() bool {
	return e.deleted
}


func (e *PostalCodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPostalCodeEntity(e.client, opts)
}

func (e *PostalCodeEntity) Data(args ...any) any {
...
func (e *PostalCodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PostalCode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PostalCodeEntity) DataTyped(data ...PostalCode) PostalCode {
	if len(data) > 0 {
		return typedFrom[PostalCode](e.Data(asMap(data[0])))
	}
	return typedFrom[PostalCode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PostalCode (all fields
// optional at the wire level).
func (e *PostalCodeEntity) MatchTyped(match ...PostalCode) PostalCode {
	if len(match) > 0 {
		return typedFrom[PostalCode](e.Match(asMap(match[0])))
	}
	return typedFrom[PostalCode](e.Match())
}
...
func (e *PostalCodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PostalCodeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PostalCodeLoadMatch and returns an PostalCode. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PostalCodeEntity) LoadTyped(reqmatch PostalCodeLoadMatch, ctrl map[string]any) (PostalCode, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PostalCode{}, err
	}
	return typedFrom[PostalCode](res), nil
}



func (e *PostalCodeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PostalCodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PostalCodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PostalCodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PostalCodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
