...
func (sdk *PostaliApiRestSDK) OptionsMap() map[string]any {
...
func (sdk *PostaliApiRestSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PostaliApiRestSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PostaliApiRestSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PostaliApiRestSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PostaliApiRestSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PostaliApiRestSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PostaliApiRestSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PostaliApiRestSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PostaliApiRestSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PostaliApiRestSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *PostaliApiRestSDK {
	...
	sdk := NewPostaliApiRestSDK(sdkopts)
	sdk.Mode = "test"
