...
// PostaliApiRest SDK utility type

class PostaliApiRestUtility
{
    ...
    public static function copy(PostaliApiRestUtility $src): PostaliApiRestUtility
    {
        $u = new PostaliApiRestUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
