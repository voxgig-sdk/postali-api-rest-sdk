...
// PostaliApiRest SDK utility: graphql
//
...
class PostaliApiRestGraphql
{
    ...
    // equivalent.
    public static function body(PostaliApiRestContext $ctx): mixed
    {
    ...
    public static function errors(PostaliApiRestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
