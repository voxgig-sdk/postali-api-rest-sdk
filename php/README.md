# PostaliApiRest PHP SDK

The PHP SDK for the PostaliApiRest API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Municipality(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->PostaliApiRest(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── postaliapirest_sdk.php          -- Main SDK class
...
The main class (`postaliapirest_sdk.php`) exports the SDK class
