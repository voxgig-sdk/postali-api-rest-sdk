...
// PostaliApiRest SDK paging feature
...
class PostaliApiRestPagingFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _is_list(PostaliApiRestContext $ctx): bool
    {
