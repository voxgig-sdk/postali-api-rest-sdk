...
// PostaliApiRest SDK timeout feature
...
class PostaliApiRestTimeoutFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _with_timeout(PostaliApiRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PostaliApiRestContext $_ctx, float $ms): void
    {
        $client = $this->client;
