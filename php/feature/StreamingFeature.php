...
// PostaliApiRest SDK streaming feature
...
class PostaliApiRestStreamingFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _iterate(PostaliApiRestResult $result): \Generator
    {
    ...
    private function _streamable(PostaliApiRestContext $ctx): bool
    {
