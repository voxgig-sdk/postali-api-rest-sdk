...
// PostaliApiRest SDK idempotency feature
...
class PostaliApiRestIdempotencyFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _mutating(PostaliApiRestContext $ctx): bool
    {
