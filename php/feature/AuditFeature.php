...
// PostaliApiRest SDK audit feature
...
class PostaliApiRestAuditFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _emit(PostaliApiRestContext $ctx, string $outcome): void
    {
