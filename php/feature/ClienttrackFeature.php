...
// PostaliApiRest SDK clienttrack feature
...
class PostaliApiRestClienttrackFeature extends PostaliApiRestBaseFeature
{
    ...
    public function PostConstruct(PostaliApiRestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PostaliApiRest-SDK';
