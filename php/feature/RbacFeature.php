...
// PostaliApiRest SDK rbac feature
...
class PostaliApiRestRbacFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _required(PostaliApiRestContext $ctx): ?string
    {
    ...
    private function _reject(PostaliApiRestContext $ctx, string $required): void
    {
    ...
    private function _track(PostaliApiRestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
