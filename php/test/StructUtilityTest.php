...
// PostaliApiRest SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PostaliApiRestOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PostaliApiRestOmni::structfix($now, Struct::undef()))
                        !== json_encode(PostaliApiRestOmni::structfix($val, Struct::undef()))) {
