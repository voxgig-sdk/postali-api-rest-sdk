...
class PostalCodeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set POSTALI_API_REST_TEST_POSTAL_CODE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function postal_code_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("POSTALI_API_REST_TEST_POSTAL_CODE_ENTID");
