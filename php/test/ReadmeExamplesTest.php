...
// PostaliApiRest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PostaliApiRestSDK::test)
...
{
    private const SDK_CLASS = 'PostaliApiRestSDK';
    ...
    private const SDK_BASE = 'postaliapirest_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../postaliapirest_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
