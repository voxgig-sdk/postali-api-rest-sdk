...
|---|---|---|
| `ts/` | @voxgig-sdk/postali-api-rest-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/postali-api-rest-sdk \
      --repository voxgig-sdk/postali-api-rest-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/postali-api-rest-sdk` shows it, and
`npm trust revoke @voxgig-sdk/postali-api-rest-sdk --id=<id>` removes it.
