...
from projectname_sdk.core.control import PostaliApiRestControl
...
class PostaliApiRestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = PostaliApiRestControl()
        ...
        if isinstance(sp, PostaliApiRestSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PostaliApiRestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PostaliApiRestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return PostaliApiRestOperation({})
    ...
    def make_error(self, code, msg):
        return PostaliApiRestError(code, msg, self)
