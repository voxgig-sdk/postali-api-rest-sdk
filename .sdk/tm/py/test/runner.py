...
class PostaliApiRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PostaliApiRestTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = PostaliApiRestTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = PostaliApiRestTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
