...
class PostaliApiRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PostaliApiRestTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PostaliApiRestTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PostaliApiRestTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
