...
// PostaliApiRest SDK utility: fetcher

class PostaliApiRestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PostaliApiRestSDK/1.0)';
    ...
    public static function call(PostaliApiRestContext $ctx, string $fullurl, array $fetchdef): array
    {
