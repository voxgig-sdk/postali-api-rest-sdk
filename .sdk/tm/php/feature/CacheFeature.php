...
// PostaliApiRest SDK cache feature
...
class PostaliApiRestCacheFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _through(PostaliApiRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
