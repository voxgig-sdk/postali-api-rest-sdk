...
// PostaliApiRest SDK proxy feature
...
class PostaliApiRestProxyFeature extends PostaliApiRestBaseFeature
{
    ...
    public function init(PostaliApiRestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PostaliApiRestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
