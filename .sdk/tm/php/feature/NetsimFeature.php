...
// PostaliApiRest SDK netsim feature
...
class PostaliApiRestNetsimFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _simulate(PostaliApiRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PostaliApiRestContext $ctx, array $applied): void
    {
        $client = $this->client;
