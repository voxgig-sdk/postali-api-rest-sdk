...
// PostaliApiRest SDK ratelimit feature
...
class PostaliApiRestRatelimitFeature extends PostaliApiRestBaseFeature
{
    ...
    private function _acquire(PostaliApiRestContext $ctx): void
    {
    ...
    private function _track(PostaliApiRestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
