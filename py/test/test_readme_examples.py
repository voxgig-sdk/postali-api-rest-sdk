# PostaliApiRest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PostaliApiRestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PostaliApiRestSDK(...) and PostaliApiRestSDK.test(...) become
#      PostaliApiRestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "postaliapirest_sdk"
_SDK_CLASS = "PostaliApiRestSDK"
