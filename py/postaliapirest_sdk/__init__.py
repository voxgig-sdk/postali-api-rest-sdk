...
from postaliapirest_sdk.utility import register

# Load features
from postaliapirest_sdk.feature.base_feature import PostaliApiRestBaseFeature
from postaliapirest_sdk.features import _has_feature, _make_feature
...
class PostaliApiRestSDK:
    ...
    def get_utility(self):
        return PostaliApiRestUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PostaliApiRestSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Municipality(self, data=None) -> "MunicipalityEntity":
        ...
        from postaliapirest_sdk.entity.municipality_entity import MunicipalityEntity
    ...
    def PostalCode(self, data=None) -> "PostalCodeEntity":
        ...
        from postaliapirest_sdk.entity.postal_code_entity import PostalCodeEntity
    ...
    def State(self, data=None) -> "StateEntity":
        ...
        from postaliapirest_sdk.entity.state_entity import StateEntity
