# PostaliApiRest Python SDK



The Python SDK for the PostaliApiRest API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Municipality()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/postali-api-rest-sdk/releases)) or
...
```python
client = PostaliApiRestSDK.test(testopts, sdkopts)
```
...
```
py/
├── postaliapirest_sdk.py         -- Main SDK module
...
The main module (`postaliapirest_sdk`) exports the SDK class.
