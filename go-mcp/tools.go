...
type Args struct {
	Entity string         `json:"entity" jsonschema:"municipality | postal_code | state"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PostaliApiRestSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "postali-api-rest_list",
		Description: "List records from PostaliApiRest. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "postali-api-rest_load",
		Description: "Load a single record from PostaliApiRest. " +
...
func runOp(client *sdk.PostaliApiRestSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PostaliApiRestSDK, name string) (sdk.PostaliApiRestEntity, error) {
