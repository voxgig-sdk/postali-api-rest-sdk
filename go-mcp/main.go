// Command PostaliApiRest-mcp is an MCP server exposing the PostaliApiRest
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PostaliApiRest_list  — list records of an entity
//	PostaliApiRest_load  — load a single record of an entity
//
