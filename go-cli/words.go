...
func registerSDKWords(r *eng.Registry, client *sdk.PostaliApiRestSDK) {
...
func runOp(client *sdk.PostaliApiRestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
