...
AQL-driven CLI and REPL for the PostaliApiRest SDK. Positional arguments are
...
```sh
go build -o postali-api-rest-cli ./...
```
...
./postali-api-rest-cli list municipality
./postali-api-rest-cli load 1 municipality
./postali-api-rest-cli load '{id:1}' municipality
