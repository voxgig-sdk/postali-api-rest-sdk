# PostaliApiRest Ruby SDK



The Ruby SDK for the PostaliApiRest API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `PostaliApiRestError` (a `StandardError` subclass), so wrap
...
```
rb/
├── PostaliApiRest_sdk.rb       -- Main SDK module
