...
class MunicipalityEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set POSTALI_API_REST_TEST_MUNICIPALITY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def municipality_basic_setup(extra)
  ...
  entid_env_raw = ENV["POSTALI_API_REST_TEST_MUNICIPALITY_ENTID"]
