...
module PostaliApiRestTestRunner
  ...
  def self.env_override(m)
    live = getenv("POSTALIAPIREST_TEST_LIVE")
    override = getenv("POSTALIAPIREST_TEST_OVERRIDE")
    ...
    explain = getenv("POSTALIAPIREST_TEST_EXPLAIN")
    m["POSTALIAPIREST_TEST_EXPLAIN"] = explain if explain && !explain.empty?
