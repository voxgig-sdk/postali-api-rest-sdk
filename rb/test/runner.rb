...
module PostaliApiRestTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("POSTALI_API_REST_TEST_LIVE")
    override = getenv("POSTALI_API_REST_TEST_OVERRIDE")
    ...
    explain = getenv("POSTALI_API_REST_TEST_EXPLAIN")
    m["POSTALI_API_REST_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PostaliApiRestTestRunner
Helpers = PostaliApiRestHelpers
Vs = VoxgigStruct
