...
#      offline in seeded test mode (PostaliApiRestSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PostaliApiRest_sdk.rb")
  SDK_CLASS = "PostaliApiRestSDK"
