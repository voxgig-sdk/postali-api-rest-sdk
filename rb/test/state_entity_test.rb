...
class StateEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = PostaliApiRestSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set POSTALI_API_REST_TEST_STATE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def state_basic_setup(extra)
  ...
  entid_env_raw = ENV["POSTALI_API_REST_TEST_STATE_ENTID"]
