...
require("postali-api-rest_types")
...
local PostaliApiRestSDK = {}
PostaliApiRestSDK.__index = PostaliApiRestSDK
...
PostaliApiRestSDK._make_feature = _make_feature


function PostaliApiRestSDK.new(options)
  local self = setmetatable({}, PostaliApiRestSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function PostaliApiRestSDK:options_map()
...
function PostaliApiRestSDK:get_utility()
  return Utility.copy(self._utility)
end


function PostaliApiRestSDK:get_root_ctx()
  return self._rootctx
end


function PostaliApiRestSDK:prepare(fetchargs)
...
function PostaliApiRestSDK:direct(fetchargs)
...
-- by passing it.
function PostaliApiRestSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function PostaliApiRestSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "PostaliApiRestSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function PostaliApiRestSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = PostaliApiRestSDK.new(sdkopts)
  sdk.mode = "test"
