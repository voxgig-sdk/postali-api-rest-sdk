# PostaliApiRest TypeScript SDK Reference

Complete API reference for the PostaliApiRest TypeScript SDK.
...
```ts
new PostaliApiRestSDK(options?: object)
```
...
#### `PostaliApiRestSDK.test(testopts?, sdkopts?)`
...
**Returns:** `PostaliApiRestSDK` instance in test mode.
...
Alias for `PostaliApiRestSDK.test()`.
...
Return the parent `PostaliApiRestSDK` instance.
