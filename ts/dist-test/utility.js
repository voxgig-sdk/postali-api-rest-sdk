...
function envOverride(m) {
    if ('TRUE' === process.env.POSTALI_API_REST_TEST_LIVE ||
        'TRUE' === process.env.POSTALI_API_REST_TEST_OVERRIDE) {
    ...
    m.POSTALI_API_REST_TEST_EXPLAIN = process.env.POSTALI_API_REST_TEST_EXPLAIN || m.POSTALI_API_REST_TEST_EXPLAIN;
    return m;
}
