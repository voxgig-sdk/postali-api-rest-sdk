...
function basicSetup(extra) {
    ...
    let idmap = transform(['postal_code01', 'postal_code02', 'postal_code03', 'codigo_postal01', 'codigo_postal02', 'codigo_postal03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
