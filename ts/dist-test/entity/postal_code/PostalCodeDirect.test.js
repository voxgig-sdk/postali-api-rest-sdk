...
(0, node_test_1.describe)('PostalCodeDirect', async () => {
    // Per-test live pacing. Delay is read from sdk-test-control.json's
    // `test.live.delayMs`; only sleeps when POSTALI_API_REST_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('POSTALI_API_REST_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PostaliApiRestSDK({
    ...
    (0, node_test_1.test)('direct-load-postal_code', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-postal_code', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.POSTALI_API_REST_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PostaliApiRestSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['POSTALI_API_REST_TEST_POSTAL_CODE_ENTID'];
    ...
    const client = new __1.PostaliApiRestSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PostalCodeDirect.test.js.map