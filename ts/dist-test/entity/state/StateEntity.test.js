...
(0, node_test_1.describe)('StateEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.PostaliApiRestSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.PostaliApiRestSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.PostaliApiRestSDK(merge([
