...
function basicSetup(extra) {
    ...
    let idmap = transform(['municipality01', 'municipality02', 'municipality03', 'municipio01', 'municipio02', 'municipio03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['POSTALI_API_REST_TEST_MUNICIPALITY_ENTID'];
