# PostaliApiRest TypeScript SDK



The TypeScript SDK for the PostaliApiRest API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Municipality()` — each with a small set of operations (`list`, `load`)
...
- Releases: [https://github.com/voxgig-sdk/postali-api-rest-sdk/releases](https://github.com/voxgig-sdk/postali-api-rest-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `PostaliApiRestSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PostaliApiRestSDK.test(testopts?, sdkopts?)` | `PostaliApiRestSDK` | Create a test-mode client. |
...
postali-api-rest/
├── src/
│   ├── PostaliApiRestSDK.ts        # Main SDK class
