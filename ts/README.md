...
The TypeScript SDK for the PostaliApiRest API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new PostaliApiRestSDK({ apikey: '...' })
